...
<body>
	...
	<div id="menu">
		<ul>
			...
			<br>
			<li><input type="button" onclick=show("div2") value="我的信息"
				class="point" style="border: 0; cursor: pointer" /></li>
			<br>
			<li><input type="button" onclick=show("div3") value="我的课表"
				class="point" style="border: 0; cursor: pointer" /></li>
			<br>
			<li><input type="button" onclick=show("div4") value="我要选课"
				class="point" style="border: 0; cursor: pointer" /></li>
		</ul>
	</div>
	...
	<!-- 我的课表-->
        ...
        <thead>
            <tr>
                <th colspan="6" bgcolor="#DCDCDC" align="left">我的课表</th>
            </tr>
            <tr>
       		 ...
       		 <c:forEach items="${Queryme_mycourse }" var="course"> 
	       		 <tr>
	        	  	...
	        	  	<td width="15%" align="center">
	        	  		<a href='/Student_sys2.0/DeleteServlet?username=${Queryme_student.username}&type=sc&course=${course.cno}'
	...
	<!-- 选课 -->
        ...
        <tbody bgcolor="#F5F5F5">
        	  ...
        	  <tr>
        	  	...
        	  	<td width="15%" align="center">${course.ctime }</td>
        	  	<td width="15%" align="center">
	        	  	<a href='/Student_sys2.0/ChooseCourseServlet?course=${course.cno}'
        	  	 style="text-decoration:none;color:black">选课</a>
	        	</td>
        	  </tr>  
        	</c:forEach>
